...
int main(int argc, char** argv) {
  ...
  33:	ff 76 04             	push   0x4(%esi)
  36:	e8 15 02 00 00       	call   250 <atoi>
  3b:	89 c3                	mov    %eax,%ebx
    int b = atoi(argv[2]);
  3d:	58                   	pop    %eax
  3e:	ff 76 08             	push   0x8(%esi)
  41:	e8 0a 02 00 00       	call   250 <atoi>
    int result = add(a,b);
  46:	5a                   	pop    %edx
  47:	59                   	pop    %ecx
  48:	50                   	push   %eax
  ...
  49:	89 c6                	mov    %eax,%esi
    int result = add(a,b);
  4b:	53                   	push   %ebx
  4c:	e8 12 03 00 00       	call   363 <add>
    printf(1, "%d + %d = %d\n", a, b, result);
  51:	89 04 24             	mov    %eax,(%esp)
  54:	56                   	push   %esi
  55:	53                   	push   %ebx
  56:	68 96 07 00 00       	push   $0x796
  5b:	6a 01                	push   $0x1
 ...
 449:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c7:	90                   	nop
          s = "(null)";
 5c8:	ba a4 07 00 00       	mov    $0x7a4,%edx
        while(*s != 0){
