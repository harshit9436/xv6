...
80100044:	bb f4 a5 10 80       	mov    $0x8010a5f4,%ebx
{
80100049:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
8010004c:	68 00 73 10 80       	push   $0x80107300
80100051:	68 c0 a5 10 80       	push   $0x8010a5c0
80100056:	e8 e5 43 00 00       	call   80104440 <initlock>
  bcache.head.next = &bcache.head;
8010005b:	83 c4 10             	add    $0x10,%esp
8010005e:	b8 bc ec 10 80       	mov    $0x8010ecbc,%eax
  bcache.head.prev = &bcache.head;
80100063:	c7 05 0c ed 10 80 bc 	movl   $0x8010ecbc,0x8010ed0c
8010006a:	ec 10 80 
  bcache.head.next = &bcache.head;
8010006d:	c7 05 10 ed 10 80 bc 	movl   $0x8010ecbc,0x8010ed10
80100074:	ec 10 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d 10 ed 10 80    	mov    %ebx,0x8010ed10
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb 60 ea 10 80    	cmp    $0x8010ea60,%ebx
...
801000dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000df:	68 c0 a5 10 80       	push   $0x8010a5c0
801000e4:	e8 27 45 00 00       	call   80104610 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 10 ed 10 80    	mov    0x8010ed10,%ebx
...
80100103:	81 fb bc ec 10 80    	cmp    $0x8010ecbc,%ebx
...
80100120:	8b 1d 0c ed 10 80    	mov    0x8010ed0c,%ebx
80100126:	81 fb bc ec 10 80    	cmp    $0x8010ecbc,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 6e                	jmp    8010019e <bread+0xce>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb bc ec 10 80    	cmp    $0x8010ecbc,%ebx
...
8010015d:	68 c0 a5 10 80       	push   $0x8010a5c0
...
8010020f:	e8 9c 41 00 00       	call   801043b0 <releasesleep>
  ...
  acquire(&bcache.lock);
80100214:	c7 04 24 c0 a5 10 80 	movl   $0x8010a5c0,(%esp)
...
80100242:	a1 10 ed 10 80       	mov    0x8010ed10,%eax
    b->prev = &bcache.head;
80100247:	c7 43 50 bc ec 10 80 	movl   $0x8010ecbc,0x50(%ebx)
    b->next = bcache.head.next;
8010024e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100251:	a1 10 ed 10 80       	mov    0x8010ed10,%eax
80100256:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100259:	89 1d 10 ed 10 80    	mov    %ebx,0x8010ed10
  }
  
  release(&bcache.lock);
8010025f:	c7 45 08 c0 a5 10 80 	movl   $0x8010a5c0,0x8(%ebp)
}
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 fe 78 10 80 	movl   $0x801078fe,(%esp)
...
8010088b:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
8010088e:	68 c0 ef 10 80       	push   $0x8010efc0
...
801008d3:	a1 a8 ef 10 80       	mov    0x8010efa8,%eax
801008d8:	89 c2                	mov    %eax,%edx
801008da:	2b 15 a0 ef 10 80    	sub    0x8010efa0,%edx
801008e0:	83 fa 7f             	cmp    $0x7f,%edx
801008e3:	77 d2                	ja     801008b7 <consoleintr+0x37>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e5:	8d 48 01             	lea    0x1(%eax),%ecx
  if(panicked){
801008e8:	8b 15 f8 ef 10 80    	mov    0x8010eff8,%edx
        input.buf[input.e++ % INPUT_BUF] = c;
801008ee:	83 e0 7f             	and    $0x7f,%eax
801008f1:	89 0d a8 ef 10 80    	mov    %ecx,0x8010efa8
        c = (c == '\r') ? '\n' : c;
801008f7:	83 fb 0d             	cmp    $0xd,%ebx
801008fa:	0f 84 13 01 00 00    	je     80100a13 <consoleintr+0x193>
        input.buf[input.e++ % INPUT_BUF] = c;
80100900:	88 98 20 ef 10 80    	mov    %bl,-0x7fef10e0(%eax)
  if(panicked){
...
80100927:	a1 a0 ef 10 80       	mov    0x8010efa0,%eax
8010092c:	83 e8 80             	sub    $0xffffff80,%eax
8010092f:	39 05 a8 ef 10 80    	cmp    %eax,0x8010efa8
80100935:	75 80                	jne    801008b7 <consoleintr+0x37>
80100937:	e9 fb 00 00 00       	jmp    80100a37 <consoleintr+0x1b7>
8010093c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      while(input.e != input.w &&
80100940:	a1 a8 ef 10 80       	mov    0x8010efa8,%eax
80100945:	39 05 a4 ef 10 80    	cmp    %eax,0x8010efa4
...
80100956:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100959:	80 ba 20 ef 10 80 0a 	cmpb   $0xa,-0x7fef10e0(%edx)
80100960:	0f 84 51 ff ff ff    	je     801008b7 <consoleintr+0x37>
  if(panicked){
80100966:	8b 15 f8 ef 10 80    	mov    0x8010eff8,%edx
        input.e--;
8010096c:	a3 a8 ef 10 80       	mov    %eax,0x8010efa8
  if(panicked){
...
8010097f:	90                   	nop
      if(input.e != input.w){
80100980:	a1 a8 ef 10 80       	mov    0x8010efa8,%eax
80100985:	3b 05 a4 ef 10 80    	cmp    0x8010efa4,%eax
8010098b:	0f 84 26 ff ff ff    	je     801008b7 <consoleintr+0x37>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 a8 ef 10 80       	mov    %eax,0x8010efa8
  if(panicked){
80100999:	a1 f8 ef 10 80       	mov    0x8010eff8,%eax
...
801009ad:	e8 4e fa ff ff       	call   80100400 <consputc.part.0>
      while(input.e != input.w &&
801009b2:	a1 a8 ef 10 80       	mov    0x8010efa8,%eax
801009b7:	3b 05 a4 ef 10 80    	cmp    0x8010efa4,%eax
801009bd:	75 92                	jne    80100951 <consoleintr+0xd1>
801009bf:	e9 f3 fe ff ff       	jmp    801008b7 <consoleintr+0x37>
801009c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&cons.lock);
801009c8:	83 ec 0c             	sub    $0xc,%esp
801009cb:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100a0e:	e9 cd 37 00 00       	jmp    801041e0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
80100a13:	c6 80 20 ef 10 80 0a 	movb   $0xa,-0x7fef10e0(%eax)
  if(panicked){
...
80100a2d:	e8 ce f9 ff ff       	call   80100400 <consputc.part.0>
          input.w = input.e;
80100a32:	a1 a8 ef 10 80       	mov    0x8010efa8,%eax
          wakeup(&input.r);
80100a37:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a3a:	a3 a4 ef 10 80       	mov    %eax,0x8010efa4
          wakeup(&input.r);
80100a3f:	68 a0 ef 10 80       	push   $0x8010efa0
...
80100a6b:	68 c0 ef 10 80       	push   $0x8010efc0
...
80100a79:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a7b:	c7 05 ac f9 10 80 90 	movl   $0x80100590,0x8010f9ac
80100a82:	05 10 80 
  devsw[CONSOLE].read = consoleread;
80100a85:	c7 05 a8 f9 10 80 80 	movl   $0x80100280,0x8010f9a8
80100a8c:	02 10 80 
  cons.locking = 1;
80100a8f:	c7 05 f4 ef 10 80 01 	movl   $0x1,0x8010eff4
80100a96:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100e1b:	68 00 f0 10 80       	push   $0x8010f000
...
80100e34:	bb 34 f0 10 80       	mov    $0x8010f034,%ebx
{
80100e39:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e3c:	68 00 f0 10 80       	push   $0x8010f000
...
80100e53:	81 fb 94 f9 10 80    	cmp    $0x8010f994,%ebx
...
80100e65:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100e6c:	68 00 f0 10 80       	push   $0x8010f000
...
80100e83:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e85:	68 00 f0 10 80       	push   $0x8010f000
...
80100ea7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100eaa:	68 00 f0 10 80       	push   $0x8010f000
...
80100ec4:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100ec7:	68 00 f0 10 80       	push   $0x8010f000
...
80100ef9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100efc:	68 00 f0 10 80       	push   $0x8010f000
...
80100f31:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f34:	68 00 f0 10 80       	push   $0x8010f000
  ff = *f;
...
80100f5d:	8d 76 00             	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f60:	c7 45 08 00 f0 10 80 	movl   $0x8010f000,0x8(%ebp)
}
...
801011c8:	03 05 6c 16 11 80    	add    0x8011166c,%eax
{
...
80101249:	8b 0d 54 16 11 80    	mov    0x80111654,%ecx
{
...
8010126c:	03 05 6c 16 11 80    	add    0x8011166c,%eax
...
80101281:	a1 54 16 11 80       	mov    0x80111654,%eax
...
801012d9:	39 05 54 16 11 80    	cmp    %eax,0x80111654
...
8010135a:	bb 34 fa 10 80       	mov    $0x8010fa34,%ebx
{
8010135f:	83 ec 28             	sub    $0x28,%esp
80101362:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101365:	68 00 fa 10 80       	push   $0x8010fa00
...
8010138a:	81 fb 54 16 11 80    	cmp    $0x80111654,%ebx
...
801013a9:	81 fb 54 16 11 80    	cmp    $0x80111654,%ebx
...
801013cb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013d2:	68 00 fa 10 80       	push   $0x8010fa00
...
801013fb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013fd:	68 00 fa 10 80       	push   $0x8010fa00
      ip->ref++;
...
8010141d:	81 fb 54 16 11 80    	cmp    $0x80111654,%ebx
...
80101564:	bb 40 fa 10 80       	mov    $0x8010fa40,%ebx
80101569:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010156c:	68 0b 74 10 80       	push   $0x8010740b
80101571:	68 00 fa 10 80       	push   $0x8010fa00
...
80101597:	81 fb 60 16 11 80    	cmp    $0x80111660,%ebx
...
801015b7:	68 54 16 11 80       	push   $0x80111654
801015bc:	e8 af 31 00 00       	call   80104770 <memmove>
  brelse(bp);
801015c1:	89 1c 24             	mov    %ebx,(%esp)
801015c4:	e8 27 ec ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801015c9:	ff 35 6c 16 11 80    	push   0x8011166c
801015cf:	ff 35 68 16 11 80    	push   0x80111668
801015d5:	ff 35 64 16 11 80    	push   0x80111664
801015db:	ff 35 60 16 11 80    	push   0x80111660
801015e1:	ff 35 5c 16 11 80    	push   0x8011165c
801015e7:	ff 35 58 16 11 80    	push   0x80111658
801015ed:	ff 35 54 16 11 80    	push   0x80111654
...
8010161c:	83 3d 5c 16 11 80 01 	cmpl   $0x1,0x8011165c
{
...
8010164f:	3b 3d 5c 16 11 80    	cmp    0x8011165c,%edi
80101655:	73 69                	jae    801016c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101657:	89 f8                	mov    %edi,%eax
80101659:	83 ec 08             	sub    $0x8,%esp
8010165c:	c1 e8 03             	shr    $0x3,%eax
8010165f:	03 05 68 16 11 80    	add    0x80111668,%eax
...
801016e4:	03 05 68 16 11 80    	add    0x80111668,%eax
...
80101757:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010175a:	68 00 fa 10 80       	push   $0x8010fa00
8010175f:	e8 ac 2e 00 00       	call   80104610 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 00 fa 10 80 	movl   $0x8010fa00,(%esp)
...
801017c9:	03 05 68 16 11 80    	add    0x80111668,%eax
...
801018da:	e8 d1 2a 00 00       	call   801043b0 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 00 fa 10 80 	movl   $0x8010fa00,(%esp)
801018e6:	e8 25 2d 00 00       	call   80104610 <acquire>
  ip->ref--;
801018eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018ef:	83 c4 10             	add    $0x10,%esp
801018f2:	c7 45 08 00 fa 10 80 	movl   $0x8010fa00,0x8(%ebp)
}
...
8010190b:	68 00 fa 10 80       	push   $0x8010fa00
80101910:	e8 fb 2c 00 00       	call   80104610 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 00 fa 10 80 	movl   $0x8010fa00,(%esp)
...
80101b6a:	8b 04 c5 a0 f9 10 80 	mov    -0x7fef0660(,%eax,8),%eax
...
80101c7a:	8b 04 c5 a4 f9 10 80 	mov    -0x7fef065c(,%eax,8),%eax
...
80101db2:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101db5:	68 00 fa 10 80       	push   $0x8010fa00
80101dba:	e8 51 28 00 00       	call   80104610 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 00 fa 10 80 	movl   $0x8010fa00,(%esp)
...
801021cb:	68 a0 16 11 80       	push   $0x801116a0
801021d0:	e8 6b 22 00 00       	call   80104440 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
801021d5:	58                   	pop    %eax
801021d6:	a1 24 18 11 80       	mov    0x80111824,%eax
801021db:	5a                   	pop    %edx
...
80102218:	74 f6                	je     80102210 <ideinit+0x50>
      havedisk1 = 1;
8010221a:	c7 05 80 16 11 80 01 	movl   $0x1,0x80111680
80102221:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102246:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102249:	68 a0 16 11 80       	push   $0x801116a0
8010224e:	e8 bd 23 00 00       	call   80104610 <acquire>

  if((b = idequeue) == 0){
80102253:	8b 1d 84 16 11 80    	mov    0x80111684,%ebx
...
80102263:	a3 84 16 11 80       	mov    %eax,0x80111684
...
801022ad:	e8 4e 1e 00 00       	call   80104100 <wakeup>
  ...
  if(idequeue != 0)
801022b2:	a1 84 16 11 80       	mov    0x80111684,%eax
...
801022c6:	68 a0 16 11 80       	push   $0x801116a0
...
80102313:	a1 80 16 11 80       	mov    0x80111680,%eax
...
80102323:	68 a0 16 11 80       	push   $0x801116a0
80102328:	e8 e3 22 00 00       	call   80104610 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010232d:	a1 84 16 11 80       	mov    0x80111684,%eax
  b->qnext = 0;
...
8010234c:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
8010234e:	39 1d 84 16 11 80    	cmp    %ebx,0x80111684
...
80102363:	68 a0 16 11 80       	push   $0x801116a0
...
80102379:	75 e5                	jne    80102360 <iderw+0x80>
  ...
  release(&idelock);
8010237b:	c7 45 08 a0 16 11 80 	movl   $0x801116a0,0x8(%ebp)
}
...
80102399:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801023a0:	ba 84 16 11 80       	mov    $0x80111684,%edx
...
801023d1:	c7 05 d4 16 11 80 00 	movl   $0xfec00000,0x801116d4
801023d8:	00 c0 fe 
{
...
801023e6:	00 00 00 
  return ioapic->data;
801023e9:	8b 15 d4 16 11 80    	mov    0x801116d4,%edx
801023ef:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023f2:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023f8:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023fe:	0f b6 15 20 18 11 80 	movzbl 0x80111820,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010241f:	e8 7c e2 ff ff       	call   801006a0 <cprintf>
  ioapic->reg = reg;
80102424:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
...
80102442:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
80102444:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
  for(i = 0; i <= maxintr; i++){
...
8010245c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010245e:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
...
80102480:	55                   	push   %ebp
  ioapic->reg = reg;
80102481:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
{
...
80102493:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102495:	8b 0d d4 16 11 80    	mov    0x801116d4,%ecx
...
801024a4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801024a6:	a1 d4 16 11 80       	mov    0x801116d4,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
801024d2:	81 fb f0 55 11 80    	cmp    $0x801155f0,%ebx
...
801024f2:	e8 d9 21 00 00       	call   801046d0 <memset>

  if(kmem.use_lock)
801024f7:	8b 15 14 17 11 80    	mov    0x80111714,%edx
...
80102504:	a1 18 17 11 80       	mov    0x80111718,%eax
80102509:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010250b:	a1 14 17 11 80       	mov    0x80111714,%eax
  kmem.freelist = r;
80102510:	89 1d 18 17 11 80    	mov    %ebx,0x80111718
  if(kmem.use_lock)
...
80102523:	68 e0 16 11 80       	push   $0x801116e0
80102528:	e8 e3 20 00 00       	call   80104610 <acquire>
8010252d:	83 c4 10             	add    $0x10,%esp
80102530:	eb d2                	jmp    80102504 <kfree+0x44>
80102532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
80102538:	c7 45 08 e0 16 11 80 	movl   $0x801116e0,0x8(%ebp)
}
8010253f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 68 20 00 00       	jmp    801045b0 <release>
    panic("kfree");
...
801025f2:	73 e4                	jae    801025d8 <kinit2+0x28>
  kmem.use_lock = 1;
801025f4:	c7 05 14 17 11 80 01 	movl   $0x1,0x80111714
801025fb:	00 00 00 
}
...
80102620:	68 e0 16 11 80       	push   $0x801116e0
80102625:	e8 16 1e 00 00       	call   80104440 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
8010262a:	8b 45 08             	mov    0x8(%ebp),%eax
  for(; p + PGSIZE <= (char*)vend; p += PGSIZE)
8010262d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102630:	c7 05 14 17 11 80 00 	movl   $0x0,0x80111714
80102637:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
80102680:	a1 14 17 11 80       	mov    0x80111714,%eax
80102685:	85 c0                	test   %eax,%eax
80102687:	75 1f                	jne    801026a8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
80102689:	a1 18 17 11 80       	mov    0x80111718,%eax
  if(r)
8010268e:	85 c0                	test   %eax,%eax
80102690:	74 0e                	je     801026a0 <kalloc+0x20>
    kmem.freelist = r->next;
80102692:	8b 10                	mov    (%eax),%edx
80102694:	89 15 18 17 11 80    	mov    %edx,0x80111718
  if(kmem.use_lock)
8010269a:	c3                   	ret    
...
801026ab:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801026ae:	68 e0 16 11 80       	push   $0x801116e0
801026b3:	e8 58 1f 00 00       	call   80104610 <acquire>
  r = kmem.freelist;
801026b8:	a1 18 17 11 80       	mov    0x80111718,%eax
  if(kmem.use_lock)
801026bd:	8b 15 14 17 11 80    	mov    0x80111714,%edx
  if(r)
...
801026cc:	89 0d 18 17 11 80    	mov    %ecx,0x80111718
  if(kmem.use_lock)
...
801026dc:	68 e0 16 11 80       	push   $0x801116e0
801026e1:	e8 ca 1e 00 00       	call   801045b0 <release>
  return (char*)r;
...
80102707:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102708:	8b 1d 1c 17 11 80    	mov    0x8011171c,%ebx
  data = inb(KBDATAP);
...
8010273d:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
8010273f:	89 15 1c 17 11 80    	mov    %edx,0x8011171c
  c = charcode[shift & (CTL | SHIFT)][data];
...
80102773:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102775:	89 1d 1c 17 11 80    	mov    %ebx,0x8011171c
}
...
80102799:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    shift &= ~(shiftcode[data] | E0ESC);
8010279c:	a3 1c 17 11 80       	mov    %eax,0x8011171c
    return 0;
...
{
  if(!lapic)
801027f0:	a1 20 17 11 80       	mov    0x80111720,%eax
...
{
  if (!lapic)
801028f0:	a1 20 17 11 80       	mov    0x80111720,%eax
...
{
  if(lapic)
80102910:	a1 20 17 11 80       	mov    0x80111720,%eax
...
80102978:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
8010297e:	a1 20 17 11 80       	mov    0x80111720,%eax
...
80102af7:	e8 24 1c 00 00       	call   80104720 <memcmp>
...
80102bc0:	8b 0d 88 17 11 80    	mov    0x80111788,%ecx
...
80102be0:	a1 74 17 11 80       	mov    0x80111774,%eax
80102be5:	83 ec 08             	sub    $0x8,%esp
80102be8:	01 f8                	add    %edi,%eax
80102bea:	83 c0 01             	add    $0x1,%eax
80102bed:	50                   	push   %eax
80102bee:	ff 35 84 17 11 80    	push   0x80111784
80102bf4:	e8 d7 d4 ff ff       	call   801000d0 <bread>
80102bf9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bfb:	58                   	pop    %eax
80102bfc:	5a                   	pop    %edx
80102bfd:	ff 34 bd 8c 17 11 80 	push   -0x7feee874(,%edi,4)
80102c04:	ff 35 84 17 11 80    	push   0x80111784
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c24:	e8 47 1b 00 00       	call   80104770 <memmove>
...
80102c44:	39 3d 88 17 11 80    	cmp    %edi,0x80111788
...
80102c67:	ff 35 74 17 11 80    	push   0x80111774
80102c6d:	ff 35 84 17 11 80    	push   0x80111784
...
80102c7b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c7d:	a1 88 17 11 80       	mov    0x80111788,%eax
...
80102c90:	8b 0c 95 8c 17 11 80 	mov    -0x7feee874(,%edx,4),%ecx
...
80102ccf:	68 40 17 11 80       	push   $0x80111740
80102cd4:	e8 67 17 00 00       	call   80104440 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102ce8:	59                   	pop    %ecx
  log.dev = dev;
80102ce9:	89 1d 84 17 11 80    	mov    %ebx,0x80111784
  log.size = sb.nlog;
80102cef:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cf2:	a3 74 17 11 80       	mov    %eax,0x80111774
  log.size = sb.nlog;
80102cf7:	89 15 78 17 11 80    	mov    %edx,0x80111778
  struct buf *buf = bread(log.dev, log.start);
80102cfd:	5a                   	pop    %edx
...
80102d0b:	89 1d 88 17 11 80    	mov    %ebx,0x80111788
  for (i = 0; i < log.lh.n; i++) {
...
80102d24:	89 0c 95 8c 17 11 80 	mov    %ecx,-0x7feee874(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d3b:	e8 80 fe ff ff       	call   80102bc0 <install_trans>
  log.lh.n = 0;
80102d40:	c7 05 88 17 11 80 00 	movl   $0x0,0x80111788
80102d47:	00 00 00 
...
80102d63:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d66:	68 40 17 11 80       	push   $0x80111740
80102d6b:	e8 a0 18 00 00       	call   80104610 <acquire>
...
80102d7b:	68 40 17 11 80       	push   $0x80111740
80102d80:	68 40 17 11 80       	push   $0x80111740
80102d85:	e8 b6 12 00 00       	call   80104040 <sleep>
80102d8a:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d8d:	a1 80 17 11 80       	mov    0x80111780,%eax
80102d92:	85 c0                	test   %eax,%eax
80102d94:	75 e2                	jne    80102d78 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d96:	a1 7c 17 11 80       	mov    0x8011177c,%eax
80102d9b:	8b 15 88 17 11 80    	mov    0x80111788,%edx
...
80102daf:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102db2:	a3 7c 17 11 80       	mov    %eax,0x8011177c
      release(&log.lock);
80102db7:	68 40 17 11 80       	push   $0x80111740
...
80102dd6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dd9:	68 40 17 11 80       	push   $0x80111740
80102dde:	e8 2d 18 00 00       	call   80104610 <acquire>
  log.outstanding -= 1;
80102de3:	a1 7c 17 11 80       	mov    0x8011177c,%eax
  if(log.committing)
80102de8:	8b 35 80 17 11 80    	mov    0x80111780,%esi
80102dee:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102df1:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102df4:	89 1d 7c 17 11 80    	mov    %ebx,0x8011177c
  if(log.committing)
...
80102e04:	0f 85 f6 00 00 00    	jne    80102f00 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102e0a:	c7 05 80 17 11 80 01 	movl   $0x1,0x80111780
80102e11:	00 00 00 
...
80102e17:	68 40 17 11 80       	push   $0x80111740
80102e1c:	e8 8f 17 00 00       	call   801045b0 <release>
}
...
{
  if (log.lh.n > 0) {
80102e21:	8b 0d 88 17 11 80    	mov    0x80111788,%ecx
80102e27:	83 c4 10             	add    $0x10,%esp
80102e2a:	85 c9                	test   %ecx,%ecx
80102e2c:	7f 42                	jg     80102e70 <end_op+0xa0>
    acquire(&log.lock);
80102e2e:	83 ec 0c             	sub    $0xc,%esp
80102e31:	68 40 17 11 80       	push   $0x80111740
80102e36:	e8 d5 17 00 00       	call   80104610 <acquire>
    wakeup(&log);
80102e3b:	c7 04 24 40 17 11 80 	movl   $0x80111740,(%esp)
    log.committing = 0;
80102e42:	c7 05 80 17 11 80 00 	movl   $0x0,0x80111780
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 af 12 00 00       	call   80104100 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 40 17 11 80 	movl   $0x80111740,(%esp)
80102e58:	e8 53 17 00 00       	call   801045b0 <release>
...
80102e70:	a1 74 17 11 80       	mov    0x80111774,%eax
80102e75:	83 ec 08             	sub    $0x8,%esp
80102e78:	01 d8                	add    %ebx,%eax
80102e7a:	83 c0 01             	add    $0x1,%eax
80102e7d:	50                   	push   %eax
80102e7e:	ff 35 84 17 11 80    	push   0x80111784
80102e84:	e8 47 d2 ff ff       	call   801000d0 <bread>
80102e89:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e8b:	58                   	pop    %eax
80102e8c:	5a                   	pop    %edx
80102e8d:	ff 34 9d 8c 17 11 80 	push   -0x7feee874(,%ebx,4)
80102e94:	ff 35 84 17 11 80    	push   0x80111784
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102eb4:	e8 b7 18 00 00       	call   80104770 <memmove>
...
80102ed4:	3b 1d 88 17 11 80    	cmp    0x80111788,%ebx
...
80102ee1:	e8 da fc ff ff       	call   80102bc0 <install_trans>
    log.lh.n = 0;
80102ee6:	c7 05 88 17 11 80 00 	movl   $0x0,0x80111788
80102eed:	00 00 00 
...
80102f03:	68 40 17 11 80       	push   $0x80111740
80102f08:	e8 f3 11 00 00       	call   80104100 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 40 17 11 80 	movl   $0x80111740,(%esp)
80102f14:	e8 97 16 00 00       	call   801045b0 <release>
...
80102f47:	8b 15 88 17 11 80    	mov    0x80111788,%edx
{
80102f4d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f50:	83 fa 1d             	cmp    $0x1d,%edx
80102f53:	0f 8f 85 00 00 00    	jg     80102fde <log_write+0x9e>
80102f59:	a1 78 17 11 80       	mov    0x80111778,%eax
80102f5e:	83 e8 01             	sub    $0x1,%eax
80102f61:	39 c2                	cmp    %eax,%edx
80102f63:	7d 79                	jge    80102fde <log_write+0x9e>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f65:	a1 7c 17 11 80       	mov    0x8011177c,%eax
...
80102f71:	68 40 17 11 80       	push   $0x80111740
80102f76:	e8 95 16 00 00       	call   80104610 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f7b:	8b 15 88 17 11 80    	mov    0x80111788,%edx
...
80102f95:	74 29                	je     80102fc0 <log_write+0x80>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f97:	39 0c 85 8c 17 11 80 	cmp    %ecx,-0x7feee874(,%eax,4)
80102f9e:	75 f0                	jne    80102f90 <log_write+0x50>
      break;
  }
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 85 8c 17 11 80 	mov    %ecx,-0x7feee874(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102faa:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102fad:	c7 45 08 40 17 11 80 	movl   $0x80111740,0x8(%ebp)
}
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 f6 15 00 00       	jmp    801045b0 <release>
80102fba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fc0:	89 0c 95 8c 17 11 80 	mov    %ecx,-0x7feee874(,%edx,4)
    log.lh.n++;
80102fc7:	83 c2 01             	add    $0x1,%edx
80102fca:	89 15 88 17 11 80    	mov    %edx,0x80111788
80102fd0:	eb d5                	jmp    80102fa7 <log_write+0x67>
  log.lh.block[i] = b->blockno;
80102fd2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fd5:	a3 8c 17 11 80       	mov    %eax,0x8011178c
  if (i == log.lh.n)
...
80103077:	68 f0 55 11 80       	push   $0x801155f0
...
801030ca:	68 2c a5 10 80       	push   $0x8010a52c
801030cf:	68 00 70 00 80       	push   $0x80007000
801030d4:	e8 97 16 00 00       	call   80104770 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
801030d9:	83 c4 10             	add    $0x10,%esp
801030dc:	69 05 24 18 11 80 b0 	imul   $0xb0,0x80111824,%eax
801030e3:	00 00 00 
801030e6:	05 40 18 11 80       	add    $0x80111840,%eax
801030eb:	3d 40 18 11 80       	cmp    $0x80111840,%eax
801030f0:	76 7e                	jbe    80103170 <main+0x110>
801030f2:	bb 40 18 11 80       	mov    $0x80111840,%ebx
801030f7:	eb 20                	jmp    80103119 <main+0xb9>
801030f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103100:	69 05 24 18 11 80 b0 	imul   $0xb0,0x80111824,%eax
80103107:	00 00 00 
8010310a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103110:	05 40 18 11 80       	add    $0x80111840,%eax
...
801031c4:	e8 57 15 00 00       	call   80104720 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 9c 14 00 00       	call   80104720 <memcmp>
...
801032d6:	a3 20 17 11 80       	mov    %eax,0x80111720
...
80103354:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
80103357:	88 0d 20 18 11 80    	mov    %cl,0x80111820
      continue;
8010335d:	eb 99                	jmp    801032f8 <mpinit+0xe8>
8010335f:	90                   	nop
      if(ncpu < NCPU) {
80103360:	8b 0d 24 18 11 80    	mov    0x80111824,%ecx
...
80103378:	89 0d 24 18 11 80    	mov    %ecx,0x80111824
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 40 18 11 80    	mov    %bl,-0x7feee7c0(%edi)
...
801033c8:	e8 53 13 00 00       	call   80104720 <memcmp>
...
801034a0:	00 00 00 
  initlock(&p->lock, "pipe");
801034a3:	68 e0 79 10 80       	push   $0x801079e0
801034a8:	50                   	push   %eax
801034a9:	e8 92 0f 00 00       	call   80104440 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 cc 10 00 00       	call   80104610 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 27 10 00 00       	jmp    801045b0 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 17 10 00 00       	call   801045b0 <release>
    kfree((char*)p);
...
801035dd:	e8 2e 10 00 00       	call   80104610 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 3f 0f 00 00       	call   801045b0 <release>
        return -1;
...
801036c2:	e8 e9 0e 00 00       	call   801045b0 <release>
  return n;
...
801036e6:	e8 25 0f 00 00       	call   80104610 <acquire>
...
8010377e:	e8 2d 0e 00 00       	call   801045b0 <release>
  return i;
...
80103799:	e8 12 0e 00 00       	call   801045b0 <release>
      return -1;
...
801037b4:	bb f4 1d 11 80       	mov    $0x80111df4,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 c0 1d 11 80       	push   $0x80111dc0
801037c1:	e8 4a 0e 00 00       	call   80104610 <acquire>
...
801037d3:	81 fb f4 3c 11 80    	cmp    $0x80113cf4,%ebx
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 c0 1d 11 80       	push   $0x80111dc0
  p->pid = nextpid++;
801037fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103802:	e8 a9 0d 00 00       	call   801045b0 <release>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 c5 59 10 80 	movl   $0x801059c5,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 95 0e 00 00       	call   801046d0 <memset>
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 c0 1d 11 80       	push   $0x80111dc0
8010385a:	e8 51 0d 00 00       	call   801045b0 <release>
}
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 c0 1d 11 80       	push   $0x80111dc0
8010388b:	e8 20 0d 00 00       	call   801045b0 <release>
...
801038d6:	68 3b 78 10 80       	push   $0x8010783b
801038db:	68 c0 1d 11 80       	push   $0x80111dc0
801038e0:	e8 5b 0b 00 00       	call   80104440 <initlock>
}
...
801038fc:	e8 ef ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103901:	8b 35 24 18 11 80    	mov    0x80111824,%esi
...
8010391d:	0f b6 99 40 18 11 80 	movzbl -0x7feee7c0(%ecx),%ebx
80103924:	39 c3                	cmp    %eax,%ebx
80103926:	75 e8                	jne    80103910 <mycpu+0x20>
}
80103928:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
8010392b:	8d 81 40 18 11 80    	lea    -0x7feee7c0(%ecx),%eax
}
80103931:	5b                   	pop    %ebx
80103932:	5e                   	pop    %esi
80103933:	5d                   	pop    %ebp
...
8010395b:	c9                   	leave  
  return mycpu()-cpus;
8010395c:	2d 40 18 11 80       	sub    $0x80111840,%eax
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 44 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 84 0b 00 00       	call   80104510 <popcli>
}
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 f4 3c 11 80       	mov    %eax,0x80113cf4
...
801039cb:	68 00 a5 10 80       	push   $0x8010a500
...
801039e6:	e8 e5 0c 00 00       	call   801046d0 <memset>
...
80103a3f:	68 6b 78 10 80       	push   $0x8010786b
80103a44:	50                   	push   %eax
80103a45:	e8 46 0e 00 00       	call   80104890 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 74 78 10 80 	movl   $0x80107874,(%esp)
80103a51:	e8 4a e6 ff ff       	call   801020a0 <namei>
80103a56:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a59:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
80103a60:	e8 ab 0b 00 00       	call   80104610 <acquire>
  p->state = RUNNABLE;
80103a65:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a6c:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
...
80103a83:	68 52 78 10 80       	push   $0x80107852
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 23 0a 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 63 0a 00 00       	call   80104510 <popcli>
  sz = curproc->sz;
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 a2 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 e2 09 00 00       	call   80104510 <popcli>
  if((np = allocproc()) == 0){
...
80103bc1:	e8 ca 0c 00 00       	call   80104890 <safestrcpy>
  pid = np->pid;
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
80103bd0:	e8 3b 0a 00 00       	call   80104610 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
80103be3:	e8 c8 09 00 00       	call   801045b0 <release>
  return pid;
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb f4 1d 11 80       	mov    $0x80111df4,%ebx
    acquire(&ptable.lock);
80103c59:	68 c0 1d 11 80       	push   $0x80111dc0
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 54 0c 00 00       	call   801048eb <swtch>
      switchkvm();
...
80103cac:	81 fb f4 3c 11 80    	cmp    $0x80113cf4,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 c0 1d 11 80       	push   $0x80111dc0
...
80103ced:	68 c0 1d 11 80       	push   $0x80111dc0
...
80103d33:	e8 b3 0b 00 00       	call   801048eb <swtch>
  mycpu()->intena = intena;
...
80103d99:	e8 d2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103d9e:	39 05 f4 3c 11 80    	cmp    %eax,0x80113cf4
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
...
80103e2f:	3d f4 3c 11 80       	cmp    $0x80113cf4,%eax
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
      p->parent = initproc;
80103e36:	8b 0d f4 3c 11 80    	mov    0x80113cf4,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba f4 1d 11 80       	mov    $0x80111df4,%edx
80103e41:	eb 10                	jmp    80103e53 <exit+0xc3>
80103e43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e47:	90                   	nop
80103e48:	83 c2 7c             	add    $0x7c,%edx
80103e4b:	81 fa f4 3c 11 80    	cmp    $0x80113cf4,%edx
...
80103e9d:	68 c3 78 10 80       	push   $0x801078c3
80103ea2:	e8 d9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ea7:	83 ec 0c             	sub    $0xc,%esp
80103eaa:	68 b6 78 10 80       	push   $0x801078b6
...
80103f11:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f16:	81 fb f4 3c 11 80    	cmp    $0x80113cf4,%ebx
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 c0 1d 11 80       	push   $0x80111dc0
...
80103fe0:	68 34 7a 10 80       	push   $0x80107a34
...
80103ff7:	68 c0 1d 11 80       	push   $0x80111dc0
...
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
...
80104070:	81 fe c0 1d 11 80    	cmp    $0x80111dc0,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 c0 1d 11 80       	push   $0x80111dc0
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 c0 1d 11 80 	movl   $0x80111dc0,(%esp)
...
801040e9:	68 cf 78 10 80       	push   $0x801078cf
801040ee:	e8 8d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040f3:	83 ec 0c             	sub    $0xc,%esp
801040f6:	68 34 7a 10 80       	push   $0x80107a34
...
8010413f:	3d f4 3c 11 80       	cmp    $0x80113cf4,%eax
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 c0 1d 11 80 	movl   $0x80111dc0,0x8(%ebp)
}
...
801041a6:	68 c0 1d 11 80       	push   $0x80111dc0
...
801041c3:	68 c0 1d 11 80       	push   $0x80111dc0
...
801041e9:	bb 60 1e 11 80       	mov    $0x80111e60,%ebx
...
8010421c:	74 ea                	je     80104208 <procdump+0x28>
      state = "???";
8010421e:	ba e0 78 10 80       	mov    $0x801078e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104223:	83 f8 05             	cmp    $0x5,%eax
80104226:	77 11                	ja     80104239 <procdump+0x59>
80104228:	8b 14 85 54 79 10 80 	mov    -0x7fef86ac(,%eax,4),%edx
      state = "???";
8010422f:	b8 e0 78 10 80       	mov    $0x801078e0,%eax
...
8010423e:	68 e4 78 10 80       	push   $0x801078e4
...
80104265:	e8 f6 01 00 00       	call   80104460 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042a7:	fb                   	sti    
  ...
  acquire(&ptable.lock);
801042a8:	68 c0 1d 11 80       	push   $0x80111dc0
801042ad:	bb 60 1e 11 80       	mov    $0x80111e60,%ebx
801042b2:	e8 59 03 00 00       	call   80104610 <acquire>
  for (p = ptable.proc; p < &ptable.proc[NPROC] ; p++) {
801042b7:	83 c4 10             	add    $0x10,%esp
801042ba:	eb 0f                	jmp    801042cb <call_ps+0x2b>
801042bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801042c0:	83 c3 7c             	add    $0x7c,%ebx
801042c3:	81 fb 60 3d 11 80    	cmp    $0x80113d60,%ebx
801042c9:	74 29                	je     801042f4 <call_ps+0x54>
    if (p->state != UNUSED) {
801042cb:	8b 43 a0             	mov    -0x60(%ebx),%eax
801042ce:	85 c0                	test   %eax,%eax
801042d0:	74 ee                	je     801042c0 <call_ps+0x20>
      cprintf("pid: %d name: %s \n", p->pid , p->name);
801042d2:	83 ec 04             	sub    $0x4,%esp
801042d5:	53                   	push   %ebx
  for (p = ptable.proc; p < &ptable.proc[NPROC] ; p++) {
801042d6:	83 c3 7c             	add    $0x7c,%ebx
      cprintf("pid: %d name: %s \n", p->pid , p->name);
801042d9:	ff b3 28 ff ff ff    	push   -0xd8(%ebx)
801042df:	68 ed 78 10 80       	push   $0x801078ed
801042e4:	e8 b7 c3 ff ff       	call   801006a0 <cprintf>
801042e9:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC] ; p++) {
801042ec:	81 fb 60 3d 11 80    	cmp    $0x80113d60,%ebx
801042f2:	75 d7                	jne    801042cb <call_ps+0x2b>
      // n++;
    }
  }
  release(&ptable.lock);
...
801042fc:	e8 af 02 00 00       	call   801045b0 <release>
  return 1;
  // return n;

80104301:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104304:	b8 01 00 00 00       	mov    $0x1,%eax
80104309:	c9                   	leave  
8010430a:	c3                   	ret    
...
8010431a:	68 6c 79 10 80       	push   $0x8010796c
...
80104375:	e8 c6 fc ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
80104383:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104389:	e8 e2 f5 ff ff       	call   80103970 <myproc>
...
801043d4:	e8 27 fd ff ff       	call   80104100 <wakeup>
  release(&lk->lk);
...
8010442b:	e8 40 f5 ff ff       	call   80103970 <myproc>
...
8010452b:	e8 c0 f3 ff ff       	call   801038f0 <mycpu>
...
80104555:	68 77 79 10 80       	push   $0x80107977
8010455a:	e8 21 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 8e 79 10 80       	push   $0x8010798e
...
80104593:	e8 58 f3 ff ff       	call   801038f0 <mycpu>
...
801045cb:	68 95 79 10 80       	push   $0x80107995
...
8010464c:	e8 9f f2 ff ff       	call   801038f0 <mycpu>
...
801046ab:	e8 40 f2 ff ff       	call   801038f0 <mycpu>
...
801046c0:	68 9d 79 10 80       	push   $0x8010799d
...
80104907:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010490a:	e8 61 f0 ff ff       	call   80103970 <myproc>
...
80104995:	e8 d6 ef ff ff       	call   80103970 <myproc>
...
801049a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049a6:	e8 c5 ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801049e6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
801049e9:	e8 82 ef ff ff       	call   80103970 <myproc>
801049ee:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049f0:	e8 7b ef ff ff       	call   80103970 <myproc>
...
801049fe:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a01:	e8 6a ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a54:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a55:	e8 16 ef ff ff       	call   80103970 <myproc>
...
80104a63:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a66:	e8 05 ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a7b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104a7e:	e8 ed ee ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104ad4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104ad7:	e8 94 ee ff ff       	call   80103970 <myproc>
80104adc:	89 c3                	mov    %eax,%ebx
  
  // qsort(syscall_name_arr, syscall_count_arr_size, sizeof(char*), cmpfunc);
...
80104ae7:	83 fa 18             	cmp    $0x18,%edx
80104aea:	77 34                	ja     80104b20 <syscall+0x50>
80104aec:	8b 0c 85 c0 7a 10 80 	mov    -0x7fef8540(,%eax,4),%ecx
80104af3:	85 c9                	test   %ecx,%ecx
80104af5:	74 29                	je     80104b20 <syscall+0x50>

    if(trace_state==TRACE_ON){
80104af7:	a1 20 a0 10 80       	mov    0x8010a020,%eax
80104afc:	85 c0                	test   %eax,%eax
80104afe:	75 08                	jne    80104b08 <syscall+0x38>
      syscall_count_arr[num-1] = syscall_count_arr[num-1]+1;
80104b00:	83 04 95 00 3d 11 80 	addl   $0x1,-0x7feec300(,%edx,4)
80104b07:	01 
    }
...
80104b0c:	8b 43 18             	mov    0x18(%ebx),%eax
80104b0f:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104b28:	68 a5 79 10 80       	push   $0x801079a5
...
80104c84:	68 44 7b 10 80       	push   $0x80107b44
...
80104c9c:	68 43 7b 10 80       	push   $0x80107b43
...
80104cb1:	68 37 7b 10 80       	push   $0x80107b37
...
80104ccf:	68 46 7b 10 80       	push   $0x80107b46
80104cd4:	e8 a7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104cd9:	83 ec 0c             	sub    $0xc,%esp
80104cdc:	68 28 7b 10 80       	push   $0x80107b28
...
80104cfe:	e8 8d fc ff ff       	call   80104990 <argint>
...
80104d7e:	e8 0d fc ff ff       	call   80104990 <argint>
...
80104da9:	e8 e2 fb ff ff       	call   80104990 <argint>
...
80104dbe:	e8 1d fc ff ff       	call   801049e0 <argptr>
...
80104dfe:	e8 8d fb ff ff       	call   80104990 <argint>
...
80104e29:	e8 62 fb ff ff       	call   80104990 <argint>
...
80104e3e:	e8 9d fb ff ff       	call   801049e0 <argptr>
...
80104e7e:	e8 0d fb ff ff       	call   80104990 <argint>
...
80104ea1:	74 25                	je     80104ec8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104ea3:	e8 c8 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80104ede:	e8 ad fa ff ff       	call   80104990 <argint>
...
80104f08:	e8 d3 fa ff ff       	call   801049e0 <argptr>
...
80104f4f:	e8 fc fa ff ff       	call   80104a50 <argstr>
...
80104f68:	e8 e3 fa ff ff       	call   80104a50 <argstr>
...
8010509f:	e8 ac f9 ff ff       	call   80104a50 <argstr>
...
801050dd:	58                   	pop    %eax
801050de:	5a                   	pop    %edx
801050df:	68 44 7b 10 80       	push   $0x80107b44
...
801050f8:	68 43 7b 10 80       	push   $0x80107b43
...
80105152:	e8 79 f5 ff ff       	call   801046d0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010527f:	e8 cc f7 ff ff       	call   80104a50 <argstr>
...
80105298:	e8 f3 f6 ff ff       	call   80104990 <argint>
...
801053c4:	e8 87 f6 ff ff       	call   80104a50 <argstr>
...
80105424:	e8 27 f6 ff ff       	call   80104a50 <argstr>
...
801054a5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801054a8:	e8 c3 e4 ff ff       	call   80103970 <myproc>
...
801054bd:	e8 8e f5 ff ff       	call   80104a50 <argstr>
...
80105565:	e8 e6 f4 ff ff       	call   80104a50 <argstr>
...
80105581:	e8 0a f4 ff ff       	call   80104990 <argint>
...
801055a0:	e8 2b f1 ff ff       	call   801046d0 <memset>
...
801055ca:	e8 31 f3 ff ff       	call   80104900 <fetchint>
...
801055e8:	e8 53 f3 ff ff       	call   80104940 <fetchstr>
...
80105651:	e8 8a f3 ff ff       	call   801049e0 <argptr>
...
801056b7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ba:	e8 b1 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105710:	e9 fb e3 ff ff       	jmp    80103b10 <fork>
...
80105723:	83 ec 08             	sub    $0x8,%esp
  exit();
80105726:	e8 65 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105730:	e9 8b e7 ff ff       	jmp    80103ec0 <wait>
...
8010575e:	e8 fd e9 ff ff       	call   80104160 <kill>
...
80105783:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105786:	e8 e5 e1 ff ff       	call   80103970 <myproc>
...
801057a7:	78 27                	js     801057d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057a9:	e8 c2 e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
801057b6:	e8 d5 e2 ff ff       	call   80103a90 <growproc>
...
80105800:	68 a0 3d 11 80       	push   $0x80113da0
80105805:	e8 06 ee ff ff       	call   80104610 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010580a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010580d:	8b 1d 80 3d 11 80    	mov    0x80113d80,%ebx
  while(ticks - ticks0 < n){
...
80105823:	68 a0 3d 11 80       	push   $0x80113da0
80105828:	68 80 3d 11 80       	push   $0x80113d80
8010582d:	e8 0e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105832:	a1 80 3d 11 80       	mov    0x80113d80,%eax
...
8010583f:	73 2f                	jae    80105870 <sys_sleep+0x90>
    if(myproc()->killed){
80105841:	e8 2a e1 ff ff       	call   80103970 <myproc>
...
80105850:	68 a0 3d 11 80       	push   $0x80113da0
...
80105873:	68 a0 3d 11 80       	push   $0x80113da0
...
80105894:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105897:	68 a0 3d 11 80       	push   $0x80113da0
8010589c:	e8 6f ed ff ff       	call   80104610 <acquire>
  xticks = ticks;
801058a1:	8b 1d 80 3d 11 80    	mov    0x80113d80,%ebx
  release(&tickslock);
801058a7:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
...
801058cc:	e8 bf f0 ff ff       	call   80104990 <argint>
  argint(1, &b);
801058d1:	58                   	pop    %eax
...
801058d9:	e8 b2 f0 ff ff       	call   80104990 <argint>
  return a + b;
801058de:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058e1:	03 45 f0             	add    -0x10(%ebp),%eax
}
801058e4:	c9                   	leave  
801058e5:	c3                   	ret    
...
80105900:	a1 24 a0 10 80       	mov    0x8010a024,%eax
80105905:	85 c0                	test   %eax,%eax
80105907:	74 47                	je     80105950 <sys_print_count+0x50>
{
...
80105918:	8b 04 9d 00 3d 11 80 	mov    -0x7feec300(,%ebx,4),%eax
8010591f:	85 c0                	test   %eax,%eax
80105921:	7e 18                	jle    8010593b <sys_print_count+0x3b>
      cprintf("%s %d\n", syscall_name_arr[i], syscall_count_arr[i]);
80105923:	83 ec 04             	sub    $0x4,%esp
80105926:	50                   	push   %eax
80105927:	ff 34 9d 40 a0 10 80 	push   -0x7fef5fc0(,%ebx,4)
8010592e:	68 89 7b 10 80       	push   $0x80107b89
80105933:	e8 68 ad ff ff       	call   801006a0 <cprintf>
80105938:	83 c4 10             	add    $0x10,%esp
  for(uint i = 0; i < syscall_count_arr_size; i++){
8010593b:	83 c3 01             	add    $0x1,%ebx
8010593e:	39 1d 24 a0 10 80    	cmp    %ebx,0x8010a024
80105944:	77 d2                	ja     80105918 <sys_print_count+0x18>
  }
  return 0;
}
...
80105960:	a1 20 a0 10 80       	mov    0x8010a020,%eax
    for(uint i = 0; i < syscall_count_arr_size; i++){
  ...
  if(trace_state == TRACE_ON)
80105965:	31 d2                	xor    %edx,%edx
80105967:	85 c0                	test   %eax,%eax
80105969:	0f 94 c2             	sete   %dl
    if(trace_state == TRACE_OFF){
8010596c:	83 f8 01             	cmp    $0x1,%eax
8010596f:	74 0f                	je     80105980 <sys_toggle+0x20>
80105971:	89 15 20 a0 10 80    	mov    %edx,0x8010a020
...
8010597a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(uint i = 0; i < syscall_count_arr_size; i++){
80105980:	8b 15 24 a0 10 80    	mov    0x8010a024,%edx
80105986:	31 c0                	xor    %eax,%eax
80105988:	85 d2                	test   %edx,%edx
8010598a:	74 16                	je     801059a2 <sys_toggle+0x42>
8010598c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      syscall_count_arr[i] = 0; 
80105990:	c7 04 85 00 3d 11 80 	movl   $0x0,-0x7feec300(,%eax,4)
80105997:	00 00 00 00 
    for(uint i = 0; i < syscall_count_arr_size; i++){
8010599b:	83 c0 01             	add    $0x1,%eax
8010599e:	39 d0                	cmp    %edx,%eax
801059a0:	75 ee                	jne    80105990 <sys_toggle+0x30>
    trace_state = TRACE_ON;
801059a2:	31 d2                	xor    %edx,%edx
801059a4:	31 c0                	xor    %eax,%eax
801059a6:	89 15 20 a0 10 80    	mov    %edx,0x8010a020
801059ac:	c3                   	ret    
...
801059ae:	06                   	push   %es
  pushl %fs
801059af:	0f a0                	push   %fs
  pushl %gs
801059b1:	0f a8                	push   %gs
  pushal
801059b3:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801059b4:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801059b8:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801059ba:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801059bc:	54                   	push   %esp
  call trap
801059bd:	e8 be 00 00 00       	call   80105a80 <trap>
  addl $4, %esp
801059c2:	83 c4 04             	add    $0x4,%esp
...
801059c5:	61                   	popa   
  popl %gs
801059c6:	0f a9                	pop    %gs
  popl %fs
801059c8:	0f a1                	pop    %fs
  popl %es
801059ca:	07                   	pop    %es
  popl %ds
801059cb:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801059cc:	83 c4 08             	add    $0x8,%esp
  iret
801059cf:	cf                   	iret   
...
801059e0:	8b 14 85 a4 a0 10 80 	mov    -0x7fef5f5c(,%eax,4),%edx
801059e7:	c7 04 c5 e2 3d 11 80 	movl   $0x8e000008,-0x7feec21e(,%eax,8)
801059ee:	08 00 00 8e 
801059f2:	66 89 14 c5 e0 3d 11 	mov    %dx,-0x7feec220(,%eax,8)
801059f9:	80 
801059fa:	c1 ea 10             	shr    $0x10,%edx
801059fd:	66 89 14 c5 e6 3d 11 	mov    %dx,-0x7feec21a(,%eax,8)
80105a04:	80 
  for(i = 0; i < 256; i++)
...
80105a0f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a12:	a1 a4 a1 10 80       	mov    0x8010a1a4,%eax
80105a17:	c7 05 e2 3f 11 80 08 	movl   $0xef000008,0x80113fe2
80105a1e:	00 00 ef 
  initlock(&tickslock, "time");
80105a21:	68 40 7a 10 80       	push   $0x80107a40
80105a26:	68 a0 3d 11 80       	push   $0x80113da0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a2b:	66 a3 e0 3f 11 80    	mov    %ax,0x80113fe0
80105a31:	c1 e8 10             	shr    $0x10,%eax
80105a34:	66 a3 e6 3f 11 80    	mov    %ax,0x80113fe6
  initlock(&tickslock, "time");
80105a3a:	e8 01 ea ff ff       	call   80104440 <initlock>
}
...
80105a5b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a5f:	b8 e0 3d 11 80       	mov    $0x80113de0,%eax
...
80105aa4:	ff 24 85 34 7c 10 80 	jmp    *-0x7fef83cc(,%eax,4)
...
80105b85:	68 f0 7b 10 80       	push   $0x80107bf0
...
80105bd7:	68 98 7b 10 80       	push   $0x80107b98
...
80105c15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c18:	e8 b3 ee ff ff       	call   80104ad0 <syscall>
    if(myproc()->killed)
...
80105c90:	68 a0 3d 11 80       	push   $0x80113da0
80105c95:	e8 76 e9 ff ff       	call   80104610 <acquire>
      wakeup(&ticks);
80105c9a:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
      ticks++;
80105ca1:	83 05 80 3d 11 80 01 	addl   $0x1,0x80113d80
      wakeup(&ticks);
80105ca8:	e8 53 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105cad:	c7 04 24 a0 3d 11 80 	movl   $0x80113da0,(%esp)
80105cb4:	e8 f7 e8 ff ff       	call   801045b0 <release>
...
80105cf3:	68 bc 7b 10 80       	push   $0x80107bbc
80105cf8:	e8 a3 a9 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105cfd:	83 c4 14             	add    $0x14,%esp
80105d00:	68 90 7b 10 80       	push   $0x80107b90
...
{
  if(!uart)
80105d10:	a1 e0 45 11 80       	mov    0x801145e0,%eax
...
80105d97:	74 78                	je     80105e11 <uartinit+0xd1>
  uart = 1;
80105d99:	c7 05 e0 45 11 80 01 	movl   $0x1,0x801145e0
80105da0:	00 00 00 
...
80105dac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105daf:	bf b4 7c 10 80       	mov    $0x80107cb4,%edi
...
80105dc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105dd0:	a1 e0 45 11 80       	mov    0x801145e0,%eax
...
80105e20 <uartputc>:
  if(!uart)
80105e20:	a1 e0 45 11 80       	mov    0x801145e0,%eax
...
80105e97:	6a 00                	push   $0x0
  jmp alltraps
80105e99:	e9 0f fb ff ff       	jmp    801059ad <alltraps>
...
80105ea0:	6a 01                	push   $0x1
  jmp alltraps
80105ea2:	e9 06 fb ff ff       	jmp    801059ad <alltraps>
...
80105ea9:	6a 02                	push   $0x2
  jmp alltraps
80105eab:	e9 fd fa ff ff       	jmp    801059ad <alltraps>
...
80105eb2:	6a 03                	push   $0x3
  jmp alltraps
80105eb4:	e9 f4 fa ff ff       	jmp    801059ad <alltraps>
...
80105ebb:	6a 04                	push   $0x4
  jmp alltraps
80105ebd:	e9 eb fa ff ff       	jmp    801059ad <alltraps>
...
80105ec4:	6a 05                	push   $0x5
  jmp alltraps
80105ec6:	e9 e2 fa ff ff       	jmp    801059ad <alltraps>
...
80105ecd:	6a 06                	push   $0x6
  jmp alltraps
80105ecf:	e9 d9 fa ff ff       	jmp    801059ad <alltraps>
...
80105ed6:	6a 07                	push   $0x7
  jmp alltraps
80105ed8:	e9 d0 fa ff ff       	jmp    801059ad <alltraps>
...
80105edd:	6a 08                	push   $0x8
  jmp alltraps
80105edf:	e9 c9 fa ff ff       	jmp    801059ad <alltraps>
...
80105ee6:	6a 09                	push   $0x9
  jmp alltraps
80105ee8:	e9 c0 fa ff ff       	jmp    801059ad <alltraps>
...
80105eed:	6a 0a                	push   $0xa
  jmp alltraps
80105eef:	e9 b9 fa ff ff       	jmp    801059ad <alltraps>
...
80105ef4:	6a 0b                	push   $0xb
  jmp alltraps
80105ef6:	e9 b2 fa ff ff       	jmp    801059ad <alltraps>
...
80105efb:	6a 0c                	push   $0xc
  jmp alltraps
80105efd:	e9 ab fa ff ff       	jmp    801059ad <alltraps>
...
80105f02:	6a 0d                	push   $0xd
  jmp alltraps
80105f04:	e9 a4 fa ff ff       	jmp    801059ad <alltraps>
...
80105f09:	6a 0e                	push   $0xe
  jmp alltraps
80105f0b:	e9 9d fa ff ff       	jmp    801059ad <alltraps>
...
80105f12:	6a 0f                	push   $0xf
  jmp alltraps
80105f14:	e9 94 fa ff ff       	jmp    801059ad <alltraps>
...
80105f1b:	6a 10                	push   $0x10
  jmp alltraps
80105f1d:	e9 8b fa ff ff       	jmp    801059ad <alltraps>
...
80105f22:	6a 11                	push   $0x11
  jmp alltraps
80105f24:	e9 84 fa ff ff       	jmp    801059ad <alltraps>
...
80105f2b:	6a 12                	push   $0x12
  jmp alltraps
80105f2d:	e9 7b fa ff ff       	jmp    801059ad <alltraps>
...
80105f34:	6a 13                	push   $0x13
  jmp alltraps
80105f36:	e9 72 fa ff ff       	jmp    801059ad <alltraps>
...
80105f3d:	6a 14                	push   $0x14
  jmp alltraps
80105f3f:	e9 69 fa ff ff       	jmp    801059ad <alltraps>
...
80105f46:	6a 15                	push   $0x15
  jmp alltraps
80105f48:	e9 60 fa ff ff       	jmp    801059ad <alltraps>
...
80105f4f:	6a 16                	push   $0x16
  jmp alltraps
80105f51:	e9 57 fa ff ff       	jmp    801059ad <alltraps>
...
80105f58:	6a 17                	push   $0x17
  jmp alltraps
80105f5a:	e9 4e fa ff ff       	jmp    801059ad <alltraps>
...
80105f61:	6a 18                	push   $0x18
  jmp alltraps
80105f63:	e9 45 fa ff ff       	jmp    801059ad <alltraps>
...
80105f6a:	6a 19                	push   $0x19
  jmp alltraps
80105f6c:	e9 3c fa ff ff       	jmp    801059ad <alltraps>
...
80105f73:	6a 1a                	push   $0x1a
  jmp alltraps
80105f75:	e9 33 fa ff ff       	jmp    801059ad <alltraps>
...
80105f7c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f7e:	e9 2a fa ff ff       	jmp    801059ad <alltraps>
...
80105f85:	6a 1c                	push   $0x1c
  jmp alltraps
80105f87:	e9 21 fa ff ff       	jmp    801059ad <alltraps>
...
80105f8e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f90:	e9 18 fa ff ff       	jmp    801059ad <alltraps>
...
80105f97:	6a 1e                	push   $0x1e
  jmp alltraps
80105f99:	e9 0f fa ff ff       	jmp    801059ad <alltraps>
...
80105fa0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fa2:	e9 06 fa ff ff       	jmp    801059ad <alltraps>
...
80105fa9:	6a 20                	push   $0x20
  jmp alltraps
80105fab:	e9 fd f9 ff ff       	jmp    801059ad <alltraps>
...
80105fb2:	6a 21                	push   $0x21
  jmp alltraps
80105fb4:	e9 f4 f9 ff ff       	jmp    801059ad <alltraps>
...
80105fbb:	6a 22                	push   $0x22
  jmp alltraps
80105fbd:	e9 eb f9 ff ff       	jmp    801059ad <alltraps>
...
80105fc4:	6a 23                	push   $0x23
  jmp alltraps
80105fc6:	e9 e2 f9 ff ff       	jmp    801059ad <alltraps>
...
80105fcd:	6a 24                	push   $0x24
  jmp alltraps
80105fcf:	e9 d9 f9 ff ff       	jmp    801059ad <alltraps>
...
80105fd6:	6a 25                	push   $0x25
  jmp alltraps
80105fd8:	e9 d0 f9 ff ff       	jmp    801059ad <alltraps>
...
80105fdf:	6a 26                	push   $0x26
  jmp alltraps
80105fe1:	e9 c7 f9 ff ff       	jmp    801059ad <alltraps>
...
80105fe8:	6a 27                	push   $0x27
  jmp alltraps
80105fea:	e9 be f9 ff ff       	jmp    801059ad <alltraps>
...
80105ff1:	6a 28                	push   $0x28
  jmp alltraps
80105ff3:	e9 b5 f9 ff ff       	jmp    801059ad <alltraps>
...
80105ffa:	6a 29                	push   $0x29
  jmp alltraps
80105ffc:	e9 ac f9 ff ff       	jmp    801059ad <alltraps>
...
80106003:	6a 2a                	push   $0x2a
  jmp alltraps
80106005:	e9 a3 f9 ff ff       	jmp    801059ad <alltraps>
...
8010600c:	6a 2b                	push   $0x2b
  jmp alltraps
8010600e:	e9 9a f9 ff ff       	jmp    801059ad <alltraps>
...
80106015:	6a 2c                	push   $0x2c
  jmp alltraps
80106017:	e9 91 f9 ff ff       	jmp    801059ad <alltraps>
...
8010601e:	6a 2d                	push   $0x2d
  jmp alltraps
80106020:	e9 88 f9 ff ff       	jmp    801059ad <alltraps>
...
80106027:	6a 2e                	push   $0x2e
  jmp alltraps
80106029:	e9 7f f9 ff ff       	jmp    801059ad <alltraps>
...
80106030:	6a 2f                	push   $0x2f
  jmp alltraps
80106032:	e9 76 f9 ff ff       	jmp    801059ad <alltraps>
...
80106039:	6a 30                	push   $0x30
  jmp alltraps
8010603b:	e9 6d f9 ff ff       	jmp    801059ad <alltraps>
...
80106042:	6a 31                	push   $0x31
  jmp alltraps
80106044:	e9 64 f9 ff ff       	jmp    801059ad <alltraps>
...
8010604b:	6a 32                	push   $0x32
  jmp alltraps
8010604d:	e9 5b f9 ff ff       	jmp    801059ad <alltraps>
...
80106054:	6a 33                	push   $0x33
  jmp alltraps
80106056:	e9 52 f9 ff ff       	jmp    801059ad <alltraps>
...
8010605d:	6a 34                	push   $0x34
  jmp alltraps
8010605f:	e9 49 f9 ff ff       	jmp    801059ad <alltraps>
...
80106066:	6a 35                	push   $0x35
  jmp alltraps
80106068:	e9 40 f9 ff ff       	jmp    801059ad <alltraps>
...
8010606f:	6a 36                	push   $0x36
  jmp alltraps
80106071:	e9 37 f9 ff ff       	jmp    801059ad <alltraps>
...
80106078:	6a 37                	push   $0x37
  jmp alltraps
8010607a:	e9 2e f9 ff ff       	jmp    801059ad <alltraps>
...
80106081:	6a 38                	push   $0x38
  jmp alltraps
80106083:	e9 25 f9 ff ff       	jmp    801059ad <alltraps>
...
8010608a:	6a 39                	push   $0x39
  jmp alltraps
8010608c:	e9 1c f9 ff ff       	jmp    801059ad <alltraps>
...
80106093:	6a 3a                	push   $0x3a
  jmp alltraps
80106095:	e9 13 f9 ff ff       	jmp    801059ad <alltraps>
...
8010609c:	6a 3b                	push   $0x3b
  jmp alltraps
8010609e:	e9 0a f9 ff ff       	jmp    801059ad <alltraps>
...
801060a5:	6a 3c                	push   $0x3c
  jmp alltraps
801060a7:	e9 01 f9 ff ff       	jmp    801059ad <alltraps>
...
801060ae:	6a 3d                	push   $0x3d
  jmp alltraps
801060b0:	e9 f8 f8 ff ff       	jmp    801059ad <alltraps>
...
801060b7:	6a 3e                	push   $0x3e
  jmp alltraps
801060b9:	e9 ef f8 ff ff       	jmp    801059ad <alltraps>
...
801060c0:	6a 3f                	push   $0x3f
  jmp alltraps
801060c2:	e9 e6 f8 ff ff       	jmp    801059ad <alltraps>
...
801060c9:	6a 40                	push   $0x40
  jmp alltraps
801060cb:	e9 dd f8 ff ff       	jmp    801059ad <alltraps>
...
801060d2:	6a 41                	push   $0x41
  jmp alltraps
801060d4:	e9 d4 f8 ff ff       	jmp    801059ad <alltraps>
...
801060db:	6a 42                	push   $0x42
  jmp alltraps
801060dd:	e9 cb f8 ff ff       	jmp    801059ad <alltraps>
...
801060e4:	6a 43                	push   $0x43
  jmp alltraps
801060e6:	e9 c2 f8 ff ff       	jmp    801059ad <alltraps>
...
801060ed:	6a 44                	push   $0x44
  jmp alltraps
801060ef:	e9 b9 f8 ff ff       	jmp    801059ad <alltraps>
...
801060f6:	6a 45                	push   $0x45
  jmp alltraps
801060f8:	e9 b0 f8 ff ff       	jmp    801059ad <alltraps>
...
801060ff:	6a 46                	push   $0x46
  jmp alltraps
80106101:	e9 a7 f8 ff ff       	jmp    801059ad <alltraps>
...
80106108:	6a 47                	push   $0x47
  jmp alltraps
8010610a:	e9 9e f8 ff ff       	jmp    801059ad <alltraps>
...
80106111:	6a 48                	push   $0x48
  jmp alltraps
80106113:	e9 95 f8 ff ff       	jmp    801059ad <alltraps>
...
8010611a:	6a 49                	push   $0x49
  jmp alltraps
8010611c:	e9 8c f8 ff ff       	jmp    801059ad <alltraps>
...
80106123:	6a 4a                	push   $0x4a
  jmp alltraps
80106125:	e9 83 f8 ff ff       	jmp    801059ad <alltraps>
...
8010612c:	6a 4b                	push   $0x4b
  jmp alltraps
8010612e:	e9 7a f8 ff ff       	jmp    801059ad <alltraps>
...
80106135:	6a 4c                	push   $0x4c
  jmp alltraps
80106137:	e9 71 f8 ff ff       	jmp    801059ad <alltraps>
...
8010613e:	6a 4d                	push   $0x4d
  jmp alltraps
80106140:	e9 68 f8 ff ff       	jmp    801059ad <alltraps>
...
80106147:	6a 4e                	push   $0x4e
  jmp alltraps
80106149:	e9 5f f8 ff ff       	jmp    801059ad <alltraps>
...
80106150:	6a 4f                	push   $0x4f
  jmp alltraps
80106152:	e9 56 f8 ff ff       	jmp    801059ad <alltraps>
...
80106159:	6a 50                	push   $0x50
  jmp alltraps
8010615b:	e9 4d f8 ff ff       	jmp    801059ad <alltraps>
...
80106162:	6a 51                	push   $0x51
  jmp alltraps
80106164:	e9 44 f8 ff ff       	jmp    801059ad <alltraps>
...
8010616b:	6a 52                	push   $0x52
  jmp alltraps
8010616d:	e9 3b f8 ff ff       	jmp    801059ad <alltraps>
...
80106174:	6a 53                	push   $0x53
  jmp alltraps
80106176:	e9 32 f8 ff ff       	jmp    801059ad <alltraps>
...
8010617d:	6a 54                	push   $0x54
  jmp alltraps
8010617f:	e9 29 f8 ff ff       	jmp    801059ad <alltraps>
...
80106186:	6a 55                	push   $0x55
  jmp alltraps
80106188:	e9 20 f8 ff ff       	jmp    801059ad <alltraps>
...
8010618f:	6a 56                	push   $0x56
  jmp alltraps
80106191:	e9 17 f8 ff ff       	jmp    801059ad <alltraps>
...
80106198:	6a 57                	push   $0x57
  jmp alltraps
8010619a:	e9 0e f8 ff ff       	jmp    801059ad <alltraps>
...
801061a1:	6a 58                	push   $0x58
  jmp alltraps
801061a3:	e9 05 f8 ff ff       	jmp    801059ad <alltraps>
...
801061aa:	6a 59                	push   $0x59
  jmp alltraps
801061ac:	e9 fc f7 ff ff       	jmp    801059ad <alltraps>
...
801061b3:	6a 5a                	push   $0x5a
  jmp alltraps
801061b5:	e9 f3 f7 ff ff       	jmp    801059ad <alltraps>
...
801061bc:	6a 5b                	push   $0x5b
  jmp alltraps
801061be:	e9 ea f7 ff ff       	jmp    801059ad <alltraps>
...
801061c5:	6a 5c                	push   $0x5c
  jmp alltraps
801061c7:	e9 e1 f7 ff ff       	jmp    801059ad <alltraps>
...
801061ce:	6a 5d                	push   $0x5d
  jmp alltraps
801061d0:	e9 d8 f7 ff ff       	jmp    801059ad <alltraps>
...
801061d7:	6a 5e                	push   $0x5e
  jmp alltraps
801061d9:	e9 cf f7 ff ff       	jmp    801059ad <alltraps>
...
801061e0:	6a 5f                	push   $0x5f
  jmp alltraps
801061e2:	e9 c6 f7 ff ff       	jmp    801059ad <alltraps>
...
801061e9:	6a 60                	push   $0x60
  jmp alltraps
801061eb:	e9 bd f7 ff ff       	jmp    801059ad <alltraps>
...
801061f2:	6a 61                	push   $0x61
  jmp alltraps
801061f4:	e9 b4 f7 ff ff       	jmp    801059ad <alltraps>
...
801061fb:	6a 62                	push   $0x62
  jmp alltraps
801061fd:	e9 ab f7 ff ff       	jmp    801059ad <alltraps>
...
80106204:	6a 63                	push   $0x63
  jmp alltraps
80106206:	e9 a2 f7 ff ff       	jmp    801059ad <alltraps>
...
8010620d:	6a 64                	push   $0x64
  jmp alltraps
8010620f:	e9 99 f7 ff ff       	jmp    801059ad <alltraps>
...
80106216:	6a 65                	push   $0x65
  jmp alltraps
80106218:	e9 90 f7 ff ff       	jmp    801059ad <alltraps>
...
8010621f:	6a 66                	push   $0x66
  jmp alltraps
80106221:	e9 87 f7 ff ff       	jmp    801059ad <alltraps>
...
80106228:	6a 67                	push   $0x67
  jmp alltraps
8010622a:	e9 7e f7 ff ff       	jmp    801059ad <alltraps>
...
80106231:	6a 68                	push   $0x68
  jmp alltraps
80106233:	e9 75 f7 ff ff       	jmp    801059ad <alltraps>
...
8010623a:	6a 69                	push   $0x69
  jmp alltraps
8010623c:	e9 6c f7 ff ff       	jmp    801059ad <alltraps>
...
80106243:	6a 6a                	push   $0x6a
  jmp alltraps
80106245:	e9 63 f7 ff ff       	jmp    801059ad <alltraps>
...
8010624c:	6a 6b                	push   $0x6b
  jmp alltraps
8010624e:	e9 5a f7 ff ff       	jmp    801059ad <alltraps>
...
80106255:	6a 6c                	push   $0x6c
  jmp alltraps
80106257:	e9 51 f7 ff ff       	jmp    801059ad <alltraps>
...
8010625e:	6a 6d                	push   $0x6d
  jmp alltraps
80106260:	e9 48 f7 ff ff       	jmp    801059ad <alltraps>
...
80106267:	6a 6e                	push   $0x6e
  jmp alltraps
80106269:	e9 3f f7 ff ff       	jmp    801059ad <alltraps>
...
80106270:	6a 6f                	push   $0x6f
  jmp alltraps
80106272:	e9 36 f7 ff ff       	jmp    801059ad <alltraps>
...
80106279:	6a 70                	push   $0x70
  jmp alltraps
8010627b:	e9 2d f7 ff ff       	jmp    801059ad <alltraps>
...
80106282:	6a 71                	push   $0x71
  jmp alltraps
80106284:	e9 24 f7 ff ff       	jmp    801059ad <alltraps>
...
8010628b:	6a 72                	push   $0x72
  jmp alltraps
8010628d:	e9 1b f7 ff ff       	jmp    801059ad <alltraps>
...
80106294:	6a 73                	push   $0x73
  jmp alltraps
80106296:	e9 12 f7 ff ff       	jmp    801059ad <alltraps>
...
8010629d:	6a 74                	push   $0x74
  jmp alltraps
8010629f:	e9 09 f7 ff ff       	jmp    801059ad <alltraps>
...
801062a6:	6a 75                	push   $0x75
  jmp alltraps
801062a8:	e9 00 f7 ff ff       	jmp    801059ad <alltraps>
...
801062af:	6a 76                	push   $0x76
  jmp alltraps
801062b1:	e9 f7 f6 ff ff       	jmp    801059ad <alltraps>
...
801062b8:	6a 77                	push   $0x77
  jmp alltraps
801062ba:	e9 ee f6 ff ff       	jmp    801059ad <alltraps>
...
801062c1:	6a 78                	push   $0x78
  jmp alltraps
801062c3:	e9 e5 f6 ff ff       	jmp    801059ad <alltraps>
...
801062ca:	6a 79                	push   $0x79
  jmp alltraps
801062cc:	e9 dc f6 ff ff       	jmp    801059ad <alltraps>
...
801062d3:	6a 7a                	push   $0x7a
  jmp alltraps
801062d5:	e9 d3 f6 ff ff       	jmp    801059ad <alltraps>
...
801062dc:	6a 7b                	push   $0x7b
  jmp alltraps
801062de:	e9 ca f6 ff ff       	jmp    801059ad <alltraps>
...
801062e5:	6a 7c                	push   $0x7c
  jmp alltraps
801062e7:	e9 c1 f6 ff ff       	jmp    801059ad <alltraps>
...
801062ee:	6a 7d                	push   $0x7d
  jmp alltraps
801062f0:	e9 b8 f6 ff ff       	jmp    801059ad <alltraps>
...
801062f7:	6a 7e                	push   $0x7e
  jmp alltraps
801062f9:	e9 af f6 ff ff       	jmp    801059ad <alltraps>
...
80106300:	6a 7f                	push   $0x7f
  jmp alltraps
80106302:	e9 a6 f6 ff ff       	jmp    801059ad <alltraps>
...
80106309:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010630e:	e9 9a f6 ff ff       	jmp    801059ad <alltraps>
...
80106315:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010631a:	e9 8e f6 ff ff       	jmp    801059ad <alltraps>
...
80106321:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106326:	e9 82 f6 ff ff       	jmp    801059ad <alltraps>
...
8010632d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106332:	e9 76 f6 ff ff       	jmp    801059ad <alltraps>
...
80106339:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010633e:	e9 6a f6 ff ff       	jmp    801059ad <alltraps>
...
80106345:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010634a:	e9 5e f6 ff ff       	jmp    801059ad <alltraps>
...
80106351:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106356:	e9 52 f6 ff ff       	jmp    801059ad <alltraps>
...
8010635d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106362:	e9 46 f6 ff ff       	jmp    801059ad <alltraps>
...
80106369:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010636e:	e9 3a f6 ff ff       	jmp    801059ad <alltraps>
...
80106375:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010637a:	e9 2e f6 ff ff       	jmp    801059ad <alltraps>
...
80106381:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106386:	e9 22 f6 ff ff       	jmp    801059ad <alltraps>
...
8010638d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106392:	e9 16 f6 ff ff       	jmp    801059ad <alltraps>
...
80106399:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010639e:	e9 0a f6 ff ff       	jmp    801059ad <alltraps>
...
801063a5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801063aa:	e9 fe f5 ff ff       	jmp    801059ad <alltraps>
...
801063b1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801063b6:	e9 f2 f5 ff ff       	jmp    801059ad <alltraps>
...
801063bd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063c2:	e9 e6 f5 ff ff       	jmp    801059ad <alltraps>
...
801063c9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063ce:	e9 da f5 ff ff       	jmp    801059ad <alltraps>
...
801063d5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063da:	e9 ce f5 ff ff       	jmp    801059ad <alltraps>
...
801063e1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063e6:	e9 c2 f5 ff ff       	jmp    801059ad <alltraps>
...
801063ed:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063f2:	e9 b6 f5 ff ff       	jmp    801059ad <alltraps>
...
801063f9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063fe:	e9 aa f5 ff ff       	jmp    801059ad <alltraps>
...
80106405:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010640a:	e9 9e f5 ff ff       	jmp    801059ad <alltraps>
...
80106411:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106416:	e9 92 f5 ff ff       	jmp    801059ad <alltraps>
...
8010641d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106422:	e9 86 f5 ff ff       	jmp    801059ad <alltraps>
...
80106429:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010642e:	e9 7a f5 ff ff       	jmp    801059ad <alltraps>
...
80106435:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010643a:	e9 6e f5 ff ff       	jmp    801059ad <alltraps>
...
80106441:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106446:	e9 62 f5 ff ff       	jmp    801059ad <alltraps>
...
8010644d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106452:	e9 56 f5 ff ff       	jmp    801059ad <alltraps>
...
80106459:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010645e:	e9 4a f5 ff ff       	jmp    801059ad <alltraps>
...
80106465:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010646a:	e9 3e f5 ff ff       	jmp    801059ad <alltraps>
...
80106471:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106476:	e9 32 f5 ff ff       	jmp    801059ad <alltraps>
...
8010647d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106482:	e9 26 f5 ff ff       	jmp    801059ad <alltraps>
...
80106489:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010648e:	e9 1a f5 ff ff       	jmp    801059ad <alltraps>
...
80106495:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010649a:	e9 0e f5 ff ff       	jmp    801059ad <alltraps>
...
801064a1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801064a6:	e9 02 f5 ff ff       	jmp    801059ad <alltraps>
...
801064ad:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801064b2:	e9 f6 f4 ff ff       	jmp    801059ad <alltraps>
...
801064b9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801064be:	e9 ea f4 ff ff       	jmp    801059ad <alltraps>
...
801064c5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064ca:	e9 de f4 ff ff       	jmp    801059ad <alltraps>
...
801064d1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064d6:	e9 d2 f4 ff ff       	jmp    801059ad <alltraps>
...
801064dd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064e2:	e9 c6 f4 ff ff       	jmp    801059ad <alltraps>
...
801064e9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064ee:	e9 ba f4 ff ff       	jmp    801059ad <alltraps>
...
801064f5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064fa:	e9 ae f4 ff ff       	jmp    801059ad <alltraps>
...
80106501:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106506:	e9 a2 f4 ff ff       	jmp    801059ad <alltraps>
...
8010650d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106512:	e9 96 f4 ff ff       	jmp    801059ad <alltraps>
...
80106519:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010651e:	e9 8a f4 ff ff       	jmp    801059ad <alltraps>
...
80106525:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010652a:	e9 7e f4 ff ff       	jmp    801059ad <alltraps>
...
80106531:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106536:	e9 72 f4 ff ff       	jmp    801059ad <alltraps>
...
8010653d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106542:	e9 66 f4 ff ff       	jmp    801059ad <alltraps>
...
80106549:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010654e:	e9 5a f4 ff ff       	jmp    801059ad <alltraps>
...
80106555:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010655a:	e9 4e f4 ff ff       	jmp    801059ad <alltraps>
...
80106561:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106566:	e9 42 f4 ff ff       	jmp    801059ad <alltraps>
...
8010656d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106572:	e9 36 f4 ff ff       	jmp    801059ad <alltraps>
...
80106579:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010657e:	e9 2a f4 ff ff       	jmp    801059ad <alltraps>
...
80106585:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010658a:	e9 1e f4 ff ff       	jmp    801059ad <alltraps>
...
80106591:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106596:	e9 12 f4 ff ff       	jmp    801059ad <alltraps>
...
8010659d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801065a2:	e9 06 f4 ff ff       	jmp    801059ad <alltraps>
...
801065a9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801065ae:	e9 fa f3 ff ff       	jmp    801059ad <alltraps>
...
801065b5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801065ba:	e9 ee f3 ff ff       	jmp    801059ad <alltraps>
...
801065c1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065c6:	e9 e2 f3 ff ff       	jmp    801059ad <alltraps>
...
801065cd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065d2:	e9 d6 f3 ff ff       	jmp    801059ad <alltraps>
...
801065d9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065de:	e9 ca f3 ff ff       	jmp    801059ad <alltraps>
...
801065e5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065ea:	e9 be f3 ff ff       	jmp    801059ad <alltraps>
...
801065f1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065f6:	e9 b2 f3 ff ff       	jmp    801059ad <alltraps>
...
801065fd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106602:	e9 a6 f3 ff ff       	jmp    801059ad <alltraps>
...
80106609:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010660e:	e9 9a f3 ff ff       	jmp    801059ad <alltraps>
...
80106615:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010661a:	e9 8e f3 ff ff       	jmp    801059ad <alltraps>
...
80106621:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106626:	e9 82 f3 ff ff       	jmp    801059ad <alltraps>
...
8010662d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106632:	e9 76 f3 ff ff       	jmp    801059ad <alltraps>
...
80106639:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010663e:	e9 6a f3 ff ff       	jmp    801059ad <alltraps>
...
80106645:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010664a:	e9 5e f3 ff ff       	jmp    801059ad <alltraps>
...
80106651:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106656:	e9 52 f3 ff ff       	jmp    801059ad <alltraps>
...
8010665d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106662:	e9 46 f3 ff ff       	jmp    801059ad <alltraps>
...
80106669:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010666e:	e9 3a f3 ff ff       	jmp    801059ad <alltraps>
...
80106675:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010667a:	e9 2e f3 ff ff       	jmp    801059ad <alltraps>
...
80106681:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106686:	e9 22 f3 ff ff       	jmp    801059ad <alltraps>
...
8010668d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106692:	e9 16 f3 ff ff       	jmp    801059ad <alltraps>
...
80106699:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010669e:	e9 0a f3 ff ff       	jmp    801059ad <alltraps>
...
801066a5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801066aa:	e9 fe f2 ff ff       	jmp    801059ad <alltraps>
...
801066b1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801066b6:	e9 f2 f2 ff ff       	jmp    801059ad <alltraps>
...
801066bd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066c2:	e9 e6 f2 ff ff       	jmp    801059ad <alltraps>
...
801066c9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066ce:	e9 da f2 ff ff       	jmp    801059ad <alltraps>
...
801066d5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066da:	e9 ce f2 ff ff       	jmp    801059ad <alltraps>
...
801066e1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066e6:	e9 c2 f2 ff ff       	jmp    801059ad <alltraps>
...
801066ed:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066f2:	e9 b6 f2 ff ff       	jmp    801059ad <alltraps>
...
801066f9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066fe:	e9 aa f2 ff ff       	jmp    801059ad <alltraps>
...
80106705:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010670a:	e9 9e f2 ff ff       	jmp    801059ad <alltraps>
...
80106711:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106716:	e9 92 f2 ff ff       	jmp    801059ad <alltraps>
...
8010671d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106722:	e9 86 f2 ff ff       	jmp    801059ad <alltraps>
...
80106729:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010672e:	e9 7a f2 ff ff       	jmp    801059ad <alltraps>
...
80106735:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010673a:	e9 6e f2 ff ff       	jmp    801059ad <alltraps>
...
80106741:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106746:	e9 62 f2 ff ff       	jmp    801059ad <alltraps>
...
8010674d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106752:	e9 56 f2 ff ff       	jmp    801059ad <alltraps>
...
80106759:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010675e:	e9 4a f2 ff ff       	jmp    801059ad <alltraps>
...
80106765:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010676a:	e9 3e f2 ff ff       	jmp    801059ad <alltraps>
...
80106771:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106776:	e9 32 f2 ff ff       	jmp    801059ad <alltraps>
...
8010677d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106782:	e9 26 f2 ff ff       	jmp    801059ad <alltraps>
...
80106789:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010678e:	e9 1a f2 ff ff       	jmp    801059ad <alltraps>
...
80106795:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010679a:	e9 0e f2 ff ff       	jmp    801059ad <alltraps>
...
801067a1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801067a6:	e9 02 f2 ff ff       	jmp    801059ad <alltraps>
...
801067ad:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801067b2:	e9 f6 f1 ff ff       	jmp    801059ad <alltraps>
...
801067b9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801067be:	e9 ea f1 ff ff       	jmp    801059ad <alltraps>
...
801067c5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067ca:	e9 de f1 ff ff       	jmp    801059ad <alltraps>
...
801067d1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067d6:	e9 d2 f1 ff ff       	jmp    801059ad <alltraps>
...
801067dd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067e2:	e9 c6 f1 ff ff       	jmp    801059ad <alltraps>
...
801067e9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067ee:	e9 ba f1 ff ff       	jmp    801059ad <alltraps>
...
801067f5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067fa:	e9 ae f1 ff ff       	jmp    801059ad <alltraps>
...
80106801:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106806:	e9 a2 f1 ff ff       	jmp    801059ad <alltraps>
...
8010680d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106812:	e9 96 f1 ff ff       	jmp    801059ad <alltraps>
...
80106819:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010681e:	e9 8a f1 ff ff       	jmp    801059ad <alltraps>
...
80106825:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010682a:	e9 7e f1 ff ff       	jmp    801059ad <alltraps>
...
80106831:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106836:	e9 72 f1 ff ff       	jmp    801059ad <alltraps>
...
8010683d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106842:	e9 66 f1 ff ff       	jmp    801059ad <alltraps>
...
80106849:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010684e:	e9 5a f1 ff ff       	jmp    801059ad <alltraps>
...
80106855:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010685a:	e9 4e f1 ff ff       	jmp    801059ad <alltraps>
...
80106861:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106866:	e9 42 f1 ff ff       	jmp    801059ad <alltraps>
...
8010686d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106872:	e9 36 f1 ff ff       	jmp    801059ad <alltraps>
...
80106879:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010687e:	e9 2a f1 ff ff       	jmp    801059ad <alltraps>
...
80106885:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010688a:	e9 1e f1 ff ff       	jmp    801059ad <alltraps>
...
80106891:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106896:	e9 12 f1 ff ff       	jmp    801059ad <alltraps>
...
8010689d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801068a2:	e9 06 f1 ff ff       	jmp    801059ad <alltraps>
...
801068a9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801068ae:	e9 fa f0 ff ff       	jmp    801059ad <alltraps>
...
801068b5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801068ba:	e9 ee f0 ff ff       	jmp    801059ad <alltraps>
...
801068c1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068c6:	e9 e2 f0 ff ff       	jmp    801059ad <alltraps>
...
801068cd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068d2:	e9 d6 f0 ff ff       	jmp    801059ad <alltraps>
...
801068d9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068de:	e9 ca f0 ff ff       	jmp    801059ad <alltraps>
...
801068e5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068ea:	e9 be f0 ff ff       	jmp    801059ad <alltraps>
...
801068f1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068f6:	e9 b2 f0 ff ff       	jmp    801059ad <alltraps>
...
801068fd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106902:	e9 a6 f0 ff ff       	jmp    801059ad <alltraps>
...
80106a55:	e8 76 dc ff ff       	call   801046d0 <memset>
...
80106a9d:	68 bc 7c 10 80       	push   $0x80107cbc
...
80106aca:	c7 80 b8 18 11 80 ff 	movl   $0xffff,-0x7feee748(%eax)
80106ad1:	ff 00 00 
80106ad4:	c7 80 bc 18 11 80 00 	movl   $0xcf9a00,-0x7feee744(%eax)
80106adb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106ade:	c7 80 c0 18 11 80 ff 	movl   $0xffff,-0x7feee740(%eax)
80106ae5:	ff 00 00 
80106ae8:	c7 80 c4 18 11 80 00 	movl   $0xcf9200,-0x7feee73c(%eax)
80106aef:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106af2:	c7 80 c8 18 11 80 ff 	movl   $0xffff,-0x7feee738(%eax)
80106af9:	ff 00 00 
80106afc:	c7 80 cc 18 11 80 00 	movl   $0xcffa00,-0x7feee734(%eax)
80106b03:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106b06:	c7 80 d0 18 11 80 ff 	movl   $0xffff,-0x7feee730(%eax)
80106b0d:	ff 00 00 
80106b10:	c7 80 d4 18 11 80 00 	movl   $0xcff200,-0x7feee72c(%eax)
80106b17:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106b1a:	05 b0 18 11 80       	add    $0x801118b0,%eax
  pd[1] = (uint)p;
...
80106b40:	a1 e4 45 11 80       	mov    0x801145e4,%eax
...
80106b74:	0f 84 c2 00 00 00    	je     80106c3c <switchuvm+0xec>
  pushcli();
80106b7a:	e8 41 d9 ff ff       	call   801044c0 <pushcli>
...
80106cc2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cc3:	e9 a8 da ff ff       	jmp    80104770 <memmove>
    panic("inituvm: more than a page");
80106cc8:	83 ec 0c             	sub    $0xc,%esp
80106ccb:	68 01 7d 10 80       	push   $0x80107d01
...
80106d30:	68 1b 7d 10 80       	push   $0x80107d1b
...
80106db8:	68 bc 7d 10 80       	push   $0x80107dbc
...
80106e1b:	e8 b0 d8 ff ff       	call   801046d0 <memset>
...
80106e59:	68 39 7d 10 80       	push   $0x80107d39
...
80106ebb:	68 51 7d 10 80       	push   $0x80107d51
...
80106f9c:	68 6d 7d 10 80       	push   $0x80107d6d
...
80106fc3:	bb c0 a4 10 80       	mov    $0x8010a4c0,%ebx
  memset(pgdir, 0, PGSIZE);
80106fc8:	68 00 10 00 00       	push   $0x1000
80106fcd:	6a 00                	push   $0x0
80106fcf:	50                   	push   %eax
80106fd0:	e8 fb d6 ff ff       	call   801046d0 <memset>
...
80106ffa:	81 fb 00 a5 10 80    	cmp    $0x8010a500,%ebx
...
8010703b:	a3 e4 45 11 80       	mov    %eax,0x801145e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010706c:	68 7e 7d 10 80       	push   $0x80107d7e
...
801070e2:	68 88 7d 10 80       	push   $0x80107d88
...
80107140:	e8 2b d6 ff ff       	call   80104770 <memmove>
...
801071b7:	68 a2 7d 10 80       	push   $0x80107da2
...
80107270:	e8 fb d4 ff ff       	call   80104770 <memmove>
    len -= n;
    buf += n;
